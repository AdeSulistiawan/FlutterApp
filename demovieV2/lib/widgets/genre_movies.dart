...
import 'package:demovie/bloc/get_movies_byGenre_bloc.dart';
import 'package:demovie/model/movie.dart';
import 'package:demovie/model/movie_response.dart';
import 'package:demovie/screens/detail_screen.dart';
...
class _GenreMoviesState extends State<GenreMovies> {
  ...
  void initState() {
    super.initState();
    moviesByGenBloc..getMoviesByGenre(genreId);
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: moviesByGenBloc.subject.stream,
